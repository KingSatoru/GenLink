...
(function () {
  ...
  // Compute the best "site root" to return to (same logic as notyet.html).
  ...
  function init() {
    ...
    // compute base once and use for navigation
    ...
    if (homeLink) {
      // set correct href so middle-click/new-tab works
      homeLink.setAttribute('href', siteRoot);
      homeLink.addEventListener('click', () => { /* regular navigation */ });
    }
  }
